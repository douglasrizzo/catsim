...
Let :math:`\mathcal{R}` denote the remaining items and
:math:`I_i(\hat{\theta})` the information of candidate item :math:`i` at the
...
where :math:`\epsilon` is the configured minimum-information threshold.
