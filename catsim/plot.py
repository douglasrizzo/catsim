...
def test_progress(
    ...
    .. plot::
        ...
        plot.test_progress(simulator=s, index=0, true_theta=s.examinees[0], see=True, reliability=True)
    ...
    :param see: plot the test reliability. It only works if both proficiencies and administered items are passed.
