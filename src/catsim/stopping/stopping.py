...
class TestLengthStopper(BaseStopper):
  ...
  Notes
  -----
  For full algorithmic details, see :doc:`/api/techniques/stopping/test-length-stopper`.
  """
...
class MinErrorStopper(TestLengthStopper):
  ...
  Notes
  -----
  For full algorithmic details, see :doc:`/api/techniques/stopping/min-error-stopper`.
  """
...
class ConfidenceIntervalStopper(TestLengthStopper):
  ...
  Notes
  -----
  For full algorithmic details, see :doc:`/api/techniques/stopping/confidence-interval-stopper`.
  """
