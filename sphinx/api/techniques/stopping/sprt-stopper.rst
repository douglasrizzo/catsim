...
For cut score :math:`\theta_c` and indifference half-width :math:`\delta`, define
...
After :math:`n` responses, compute the log-likelihood ratio
...
where :math:`\alpha` and :math:`\beta` are the nominal Type I and Type II error
rates. The rule is:
