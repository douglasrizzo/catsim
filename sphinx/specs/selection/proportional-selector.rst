...
At position :math:`n`, item :math:`i` is selected with probability
...
Here :math:`k > 0` is a sharpness parameter and :math:`s > 0` is the same
...
.. seealso::
   ...
   Companion planned spec: :doc:`/specs/selection/progressive-selector`
