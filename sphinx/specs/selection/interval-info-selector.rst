...
For interval half-width :math:`\delta`, the selector scores each candidate item by
...
In this package, ``interval=None`` is implemented as :math:`\delta = \infty`,
...
.. seealso::
   ...
   API reference: :py:class:`catsim.selection.IntervalInfoSelector`
