...
For administered items :math:`i = 1, \dots, m` and responses
:math:`u_i \in \{0,1\}`, the estimator maximizes
...
otherwise returns :math:`+\infty` for all-correct or :math:`-\infty` for
...
.. seealso::
   ...
   API reference: :py:class:`catsim.estimation.NumericalSearchEstimator`
