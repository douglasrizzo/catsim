...
where :math:`I(\theta)` is test information and
...
The planned implementation computes :math:`\hat{\theta}_{\mathrm{MLE}}` with the
...
2. For nondegenerate response patterns, the estimate equals the underlying MLE plus the analytic correction :math:`J/(2I^2)`.
